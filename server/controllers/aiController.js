    ...
    try{
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an expert in resume writing. Your task is to enhance the professional summary of a resume. The summary should be 1-2 sentences also highlighting key skills, experience, and career objectives. Make it compelling and ATS-friendly. Ans only return text no options or anything else."
                },
                {
                    role: "user",
                    content: userContent,
    ...
    try{
        ...
        const response = await ai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an expert in resume writing. Your task is to enhance the job description of a resume. The description should be detailed, highlighting key responsibilities, achievements, and skills. Make it compelling and ATS-friendly. Ans only return text no options or anything else.",
                },
                {
                    role: "user",
                    content: userContent,
