  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        ...
        <button className='flex item-center gap-2 px-3 py-1 text-gm bg-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
